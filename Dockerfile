...
# repo queda en la imagen como red de seguridad: nginx la usa para lo que no esté en la release (URLs
# viejas de imágenes) y entera si el volumen no está montado o todavía no hay publicación. Ver nginx.conf.
COPY . /usr/share/nginx/html

# Fuentes del generador, del builder y del panel, y snapshots: no se sirven
