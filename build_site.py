...
# ------------------------------------------------------------------ partials
LOGO_SVG = ('<svg width="28" height="28" viewBox="0 0 28 28" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">'
            '<path d="M25.6667 25.6667H18.6667V17.0226L11.6667 10.027V2.33114H25.6667V25.6667ZM2.33333 25.6667V2.33114H9.33334V10.9994L16.3333 17.995V25.6776L2.33333 25.6667ZM28 0H0V28H28V0Z"/>'
            '</svg>')

WORDMARK_SVG = ('<svg class="wordmark" width="114" height="14" viewBox="0 0 114 14" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">'
...
<header class="site-header" id="siteHeader">
  <div class="header-inner">
    ...
    <a class="header-wordmark" href="{root}index.html" aria-label="ZEEKR Paraguay — Inicio">{WORDMARK_SVG}</a>
